/********************************************************
 * osPID Reflow Oven Controller by Ryan Hunt
 * Based upon:
...
Modified code to run on an Arduino with the latest version
of the RocketScream Reflow Oven Controller Shield (Jan 2013)
